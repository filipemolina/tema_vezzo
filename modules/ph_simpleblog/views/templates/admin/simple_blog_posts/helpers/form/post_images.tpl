...
<script type="text/javascript">
    var upbutton = '{l s='Upload an image' mod='ph_simpleblog'}';
    var come_from = '{$table}';
    var success_add =  '{l s='The image has been successfully added.' mod='ph_simpleblog'}';
    var id_tmp = 0;

    var ThickboxI18nImage = "{l s='Image' mod='ph_simpleblog'}";
    var ThickboxI18nOf = "{l s='of' mod='ph_simpleblog'}";
    var ThickboxI18nClose = "{l s='Close' mod='ph_simpleblog'}";
    var ThickboxI18nOrEscKey = "{l s='(or "Esc")' mod='ph_simpleblog'}";
    var ThickboxI18nNext = "{l s='Next >' mod='ph_simpleblog'}";
    var ThickboxI18nPrev = "{l s='< Previous' mod='ph_simpleblog'}";
